                ...
                <Box component="form" noValidate onSubmit={handleSubmit(onSubmit)} sx={{mt: 3}}>
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6}>
                            ...
                            />
                            {errors.firstName &&
                              <InputLabel sx={{color: 'error.main'}}>{errors.firstName?.message}</InputLabel>}
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField
                                required
                            ...
                            />
                            {errors.lastName &&
                              <InputLabel sx={{color: 'error.main'}}>{errors.lastName?.message}</InputLabel>}
                        </Grid>
                        <Grid item xs={12}>
                            <TextField
                                required
                            ...
                            />
                            {errors.email &&
                              <InputLabel sx={{color: 'error.main'}}>{errors.email?.message}</InputLabel>}
                        </Grid>
                        <Grid item xs={12}>
                            <TextField
                                required
                            ...
                            />
                            {errors.password &&
                              <InputLabel sx={{color: 'error.main'}}>{errors.password?.message}</InputLabel>}
                        </Grid>
                    </Grid>
                    <Button
                        type="submit"

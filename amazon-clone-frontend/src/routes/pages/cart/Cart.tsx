...
import {emptyCart, emptyLocalCart} from '../../../redux/CartAction';
import CartCard from './CartCard';
import {placeOrder} from '../../../api/apiRoutes';
                    ...
                    <>
                        ...
                        <TableContainer component={Paper}>
                            <Table>
                                ...
                                <TableBody>
                                    {cart.length > 0 && cart.map((product) => <CartCard product={product}
                ...
                <Dialog
                    ...
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description" sx={{color: 'black', fontSize: '20px'}}>
                            Do you want to proceed with your order and checkout?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
